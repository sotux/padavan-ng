...
tabtitle[10] = new Array("", "<#menu5_13_1#>", "<#menu5_13_2#>", "<#menu5_13_3#>");
...
tablink[10] = new Array("", "Advanced_Shadowsocks_Content.asp", "Advanced_Shadowsocks_server.asp", "Advanced_Shadowsocks_others.asp");
...
function show_menu(L1, L2, L3){
	...
	if(sw_mode == '3'){
		...
		menuL2_title[5] = "";
		menuL2_link[11] = ""; //remove shadowsocks
		menuL2_title[11] = "";
